...
import static com.adventofcode.year2019.Day11Part1.Direction.*;
...
public class Day11Part1 {
    ...
    void run() throws IOException {
        ...
        var totalPaintedPanels = totalPaintedPanels(convertToLongArray(lines.get(0)));
        log.warn("How many panels does it paint at least once? {}", totalPaintedPanels);
    }
    ...
    long totalPaintedPanels(long[] program) {
        var software = new Software(program, List.of(0l));
        var robot = new Robot();
        ...
        return panels.panel.keySet().stream().distinct().count();
    }
