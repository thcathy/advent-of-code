...
public class Day12Part1 {
    ...
    void run() throws IOException {
        ...
        var result = groupSize(programMap(lines), 0);
        System.out.printf("How many programs are in the group that contains program ID 0? %d %n", result);
    }

    int groupSize(Map<Integer, Set<Integer>> programMap, int programId) {
