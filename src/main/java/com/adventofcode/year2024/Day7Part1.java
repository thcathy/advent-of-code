...
public class Day7Part1 {
    private static final Logger log = LoggerFactory.getLogger(Day7Part1.class);
    ...
    private boolean evaluateExpressions(Equation equation, int index, long current) {
        ...
        return addResult || multiplyResult; // Return true if either operation leads to a match
    }
