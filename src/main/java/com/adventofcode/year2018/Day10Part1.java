...
public class Day10Part1 {
    ...
    void run() throws IOException {
        ...
        System.out.println("What message will eventually appear in the sky? " + "found the answer from below...");
    ...
    void printMap(List<Light> lights) {
        ...
        printMap(lightOn, minX, maxX, minY, maxY);
    }

    void printMap(Set<Position> lights, int minX, int maxX, int minY, int maxY) {
