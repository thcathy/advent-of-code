...
public class Day9Part2 {
    ...
    void run() throws IOException {
        ...
        System.out.println("What is the sum of these extrapolated values? " + result);
    ...
    record Puzzle(List<List<Integer>> histories) {
        ...
        int predictionValue(List<Integer> history) {
            ...
            return history.getFirst() - predictionValue(differences);
        }
    }
    ...
    public void unitTest() throws IOException {
        ...
        var puzzle = Puzzle.parse(lines);
        assertEquals(2, puzzle.sumOfExtrapolatedValues());
    }
}
